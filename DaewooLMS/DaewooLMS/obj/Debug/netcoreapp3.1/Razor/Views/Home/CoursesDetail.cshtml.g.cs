#pragma checksum "D:\Taimoor Work\LMS\DaewooLMS\DaewooLMS\Views\Home\CoursesDetail.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "36b2ddb50cc3bf73fae4ff55198b812f888caff7"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Home_CoursesDetail), @"mvc.1.0.view", @"/Views/Home/CoursesDetail.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"36b2ddb50cc3bf73fae4ff55198b812f888caff7", @"/Views/Home/CoursesDetail.cshtml")]
    ...
    public class Views_Home_CoursesDetail : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
#nullable restore
#line 1 "D:\Taimoor Work\LMS\DaewooLMS\DaewooLMS\Views\Home\CoursesDetail.cshtml"
  
    ViewData["Title"] = "CoursesDetail";
...
#nullable disable
  ...
  ");
    ...
    .quiz_box {");
        ...
        .quiz_box header {
            ...
            .quiz_box header .time_line {
                ...
                height: 3px;
      ");
            WriteLiteral(@"          background: #007bff;
            }
        ...
        section .option_list {
            ...
            WriteLiteral(@"      color: #004085;
                ...
                section .option_list .option .icon {
                    ...
                    pointer-events: none;
                    t");
            WriteLiteral(@"ransition: all 0.3s ease;
                    line-height: 24px;
                }
    ...
    .resu");
            WriteLiteral(@"lt_box .score_text span {
        font-size: 16px;
    }
...
<div class=""result_box"">
    ...
    <div class=""complete_text"">You've completed the Quiz!</di");
            WriteLiteral(@"v>
...
<script>
    ...
    const timeText = document.querySelector(");
            WriteLiteral(@""".timer .time_left_txt"");
    ...
    restart_quiz.onclick = () => {
        ...
        timeText.textContent = ""Time Left""; //cha");
            WriteLiteral(@"nge the text of timeText to Time Left
    ...
    next_btn.onclick = () => {
        ...
        if (que_count < questions.length - 1) { //if question count is less than total question length
            ...
            clearInterval(counterLine); //clear counterLine
            showResult();");
            WriteLiteral(@" //calling showResult function
        }
    }
    ...
    function showQuetions(index) {
       ...
       ");
            WriteLiteral(@" que_text.innerHTML = que_tag; //adding new span tag inside que_tag
    ...
    function optionSelected(answer) {
        clearInterval(");
            WriteLiteral(@"counter); //clear counter
        clearInterval(counterLine); //clear counterLine
        ...
        if (userAns == correcAns) { //if user selected option is equal to array's correct answer
            ...
            answer.insertAdja");
            WriteLiteral(@"centHTML(""beforeend"", crossIconTag); //adding cross icon to correct selected option
        ...
        next_btn.classList.add(""show""); //show the next but");
            WriteLiteral(@"ton if user selected any option
    }
  ...
  ");
            WriteLiteral(@"          let scoreTag = '<span>and sorry , You got only <p>' + userScore + '</p> out of <p>' + questions.length + '</p></span>';
            scoreText.innerHTML = scoreTag;
        }
    }
    ...
    function startTimer(time) {
        ...
        function timer() {
            ...
            if (time < 0) { //if timer is less than 0
                ...
                const allOptions = option_list.children.length; //getting all option items
                let correcAns = questions[que_count].answer; //getting correct ans");
            WriteLiteral(@"wer from array
                for (i = 0; i < allOptions; i++) {
                    if (option_list.children[i].textContent == correcAns) { //if there is an option which is matched to an array answer
                        option_list.children[i].setAttribute(""class"", ""option correct""); //adding green color to matched option
                        option_list.children[i].insertAdjacentHTML(""beforeend"", tickIconTag); //adding tick icon to matched option
...
/*    let userResponses = [];*/
    ...
    function storeResponse(answer) {
        ...
        userResponses.push({ questionWord, optionword, answer, correctAns");
            WriteLiteral(@"wer });
    }
